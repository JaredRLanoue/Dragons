...
### Dan (Program Manager) - written by Carter
...
### User Story #5 - written by Abdi Issack
...
### User Story #6 - written by Abdi Issack
...
### User Story #7 (Dan, event organizer) - written by Carter Kieke
...
### User Story #8 (Katie, group user) - written by Carter Kieke
...
### User Story #9 (Matt, group user) - written by Austin Dougherty
...
### User Story #10 (Dan, event organizer) - written by Austin Dougherty
Dan is looking for new events to put on during the summer for the parks department. To get an idea of what people may be interested in, he goes to the group-finder application and searches through users that are online and what interests are shown on their profiles. Using this Dan comes up with a few ideas for the summer that should cover a wide variety of interests for a lot of people.
...
- Requires an active internet connection at all times, no offline-mode support required.

- No real-time location tracking, users shouldn't need their location to be tracked to use the service.

- Not required to have social media integration implemented.
